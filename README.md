...
This project was written in SQL for the Harvard Online CS50 Introduction to Computer Science Problem Set 7 within the CS50 IDE (integrated development environment for students and teachers).

## Course Specification
hose in movies.db, as more votes might have been cast since we downloaded the data!
